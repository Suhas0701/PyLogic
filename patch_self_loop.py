...
class CanvasRenderer:
    ...
    def _on_pan_end(self, e):
        if self.wiring_start_pin and self.wiring_curr_wp:
            ...
            # FIXED: Removed 'target_pin.gate != self.wiring_start_pin.gate' check.
            # We now rely entirely on the Engine to reject illegal combinational self-loops!
...
print("✅ UI restriction lifted. Self-loops are now permitted!")